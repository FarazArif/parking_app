        ...
        <div className="col-12 col-lg-8">
          ...
          <div className="card border-light mb-3 py-3">
            <div className="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
              ...
              <div className="col-lg-3 col-8 pl-0 ml-2"><a href="single-message.html" className="h6 text-sm">Bonnie Green</a>
              </div>
              <div className="col col-lg-1 text-right px-0 order-lg-4"><span className="text-muted text-sm">Dec 22</span>
              </div>
              <div className="col-12 col-lg-7 d-flex align-items-center px-0">
                <div className="col col-lg-11 px-0">
                  <div className="d-flex flex-wrap flex-lg-nowrap align-items-center"><a href="single-message.html" className="col-12 col-lg pl-0 font-weight-normal text-dark d-none d-sm-block mt-2 mt-lg-0">I want to
                      rent today, is the house still valid ...</a></div>
                </div>
              </div>
            </div>
          ...
          <div className="card border-light mb-3 py-3">
            <div className="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
              ...
              <div className="col-lg-3 col-8 pl-0 ml-2"><a href="single-message.html" className="h6 text-sm">Jose Leos</a>
              </div>
              <div className="col col-lg-1 text-right px-0 order-lg-4"><span className="text-muted text-sm">Dec 2</span></div>
              <div className="col-12 col-lg-7 d-flex align-items-center px-0">
                <div className="col col-lg-11 px-0">
                  <div className="d-flex flex-wrap flex-lg-nowrap align-items-center"><a href="single-message.html" className="col-12 col-lg pl-0 font-weight-light text-gray d-none d-sm-block mt-2 mt-lg-0">I want to
                      rent today, is the house still valid ...</a></div>
                </div>
              </div>
            </div>
          ...
          <div className="card border-light mb-3 py-3">
            <div className="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
              ...
              <div className="col-lg-3 col-8 pl-0 ml-2"><a href="single-message.html" className="h6 text-sm">Chris Garth</a>
              </div>
          ...
          <div className="card border-light mb-3 py-3">
            <div className="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
              ...
              <div className="col-lg-3 col-8 pl-0 ml-2"><a href="single-message.html" className="h6 text-sm">Roberta Casas</a>
              </div>
          ...
          <div className="card border-light mb-3 py-3">
            <div className="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
              ...
              <div className="col-12 col-lg-7 d-flex align-items-center px-0">
                <div className="col col-lg-11 px-0">
                  <div className="d-flex flex-wrap flex-lg-nowrap align-items-center"><a href="single-message.html" className="col-12 col-lg pl-0 font-weight-light text-gray d-none d-sm-block">I want to rent today,
          ...
          <div className="card border-light mb-3 py-3">
            <div className="card-body d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
              ...
              <div className="col-lg-3 col-8 pl-0 ml-2"><a href="single-message.html" className="h6 text-sm">Robert Bailey</a>
              </div>
