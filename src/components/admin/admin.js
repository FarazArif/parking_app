...
export default function Admin_Panel() {
    return (
        <body className="admin_panel_most_main_div">
           
                    <nav className="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white admin_panel_nav" id="sidenav-main">
                    ...
                    <div className="main-content" id="panel">
                        ...
                        <nav className="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
                            <div className="container-fluid">
                                <div className="collapse navbar-collapse admin_panel_navbar-collapse" id="navbarSupportedContent">
                                    {/* Search form */}
                                    ...
                                    <ul className="navbar-nav align-items-center  ml-md-auto ">
                                        ...
                                        <li className="nav-item dropdown">
                                            <a className="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i className="ni ni-bell-55 adminpanel_header_icon" />
                                            </a>
                                            <div className="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden admin_panel_drop_down_nav">
                                                {/* Dropdown header */}
                                        ...
                                        <li className="nav-item dropdown">
                                            <a className="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i className="ni ni-ungroup adminpanel_header_icon" />
                                            </a>
                                            <div className="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default  dropdown-menu-right admin_panel_drop_down_nav ">
