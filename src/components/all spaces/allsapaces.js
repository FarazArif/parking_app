...
import "../spaces.css";
import All_Sapces_card from "./all_spaces_card";
  ...
  return (
    ...
    `}
      ...
      <main>
        ...
        <div
          className="section section-header section-image bg-tertiary overlay-primary text-white overflow-hidden pb-9"
          ...
          <div className="container z-2">
            <div className="row justify-content-center pt-3">
              <div className="col-12 text-center">
                ...
                <h1 className="mb-5">
                  Find a Space in{" "}
                  <span className="font-weight-bolder">New York</span>
                </h1>
              </div>
            </div>
          </div>
                        ...
                        <div className="col-12">
                          <div id="collapseAdvanced" className="collapse">
                            <div className="row">
                              ...
                              <div className="col-12 col-lg-4">
                                <div className="card border-light mt-3 p-3">
                                  <a
                                    data-target="#reviews"
                                  ...
                                  <ul
                                    id="reviews"
                                    className="collapse list-group list-group list-group-flush pt-2"
                                  >
                                      ...
                                      <div className="form-check">
                                        ...
                                        >
                                          <span className="d-flex">
                                            ...
                                            <i className="star fas fa-star text-warning" />{" "}
                                            <i className="star fas fa-star text-warning" />{" "}
                                            <span className="small font-weight-normal ml-2">
                                              (12)
                                            </span>
                                          </span>
                                        </label>
                                      ...
                                      <div className="form-check">
                                        ...
                                        >
                                          <span className="d-flex">
                                            ...
                                            <i className="star fas fa-star text-warning" />{" "}
                                            <i className="star fas fa-star text-warning" />{" "}
                                            <i className="star far fa-star text-dark" />{" "}
                                            <span className="small font-weight-normal ml-2">
                                              (22)
                                            </span>
                                          </span>
                              ...
                              <div className="col-12 col-lg-4">
                                <div className="card border-light mt-3 p-3">
                                  ...
                                  <div id="price-1" className="collapse pt-5">
                                    ...
                                    <span className="font-xs small text-gray">
                                      *Prices are in USD
                                    </span>
                                  </div>
                                </div>
                      ...
                      <div className="row">
                        <div className="col-12">
                          <div className="row align-items-center">
                            ...
                            <div className="col-6 col-lg-4 mb-3 mb-lg-0">
                              <button
                                className="btn btn-outline-gray btn-block animate-up-2"
                                type="reset"
                              >
                                Reset
                              </button>
                            ...
                            <div className="col-12 col-lg-4 d-flex justify-content-between align-items-center">
                              <a
                                ...
                                className="accordion-panel-header d-block"
                                data-toggle="collapse"
                                role="button"
                                aria-expanded="false"
                              ...
                              >
                                ...
                                <span className="icon-title font-weight-normal text-gray ml-2 mb-0">
                                  Advanced Search
                                </span>{" "}
                              </a>
            ...
            <div className="row">
              <div className="col-12 mb-5">
                <div className="justify-content-between align-items-center d-none d-md-flex">
                  <div className="mr-3">
                    <h2 className="h6 mb-3 mb-md-0">
                      Total Properties Found:{" "}
                      <span className="font-weiht-bolder text-primary">
                        207
                      </span>
                    </h2>
                  </div>
                ...
                <div
                  className="tab-content mt-4 mt-lg-4"
                  id="tabcontentexample-5"
                >
                  <div
...
{/*
      ...
      <div
        ...
        tabIndex={-1}
        role="dialog"
        aria-labelledby="map-listings"
        aria-hidden="true"
      >
        <div
          className="modal-dialog modal-dialog-centered modal-full"
          role="document"
        >
            ...
            <div className="modal-header border-0 pb-1 d-block">
              ...
              <form action="#" className="row align-items-center">
                ...
                <div className="col-12 col-lg-2 mb-2 mb-lg-0">
                  <button
                    className="btn btn-primary btn-block m-0 animate-up-2"
                    type="submit"
                  >
                    Find a desk
                  </button>
                        ...
                        <div className="row no-gutters align-items-center">
                          ...
                          <div className="col-12 col-lg-6 col-xl-7">
                            <div className="card-body px-3 py-2">
                              ...
                              <div className="d-flex my-2 small">
                                <span className="star fas fa-star text-warning" />{" "}
                                <span className="star fas fa-star text-warning" />{" "}
                                <span className="star fas fa-star text-warning" />{" "}
                                <span className="star fas fa-star text-warning" />{" "}
                                <span className="star fas fa-star text-warning" />{" "}
                                <span className="badge badge-pill small badge-primary ml-2">
                                  5.0
                                </span>
                              </div>
                              <div className="d-flex justify-content-between">
                                <div className="col pl-0">
                                  ...
                                  <span className="h5 small text-dark font-weight-bold">
                                    500$
                                  </span>
                                </div>
                                <div className="col">
                          ...
                          <div className="col-12 col-lg-6 col-xl-7">
                            <div className="card-body px-3 py-2">
                              ...
                              <div className="d-flex my-2 small">
                                ...
                                <span className="star fas fa-star text-warning" />{" "}
                                <span className="star fas fa-star text-warning" />{" "}
                                <span className="star fas fa-star-half text-warning" />{" "}
                                <span className="badge badge-pill small badge-primary ml-2">
                                  4.7
                                </span>
                              </div>
